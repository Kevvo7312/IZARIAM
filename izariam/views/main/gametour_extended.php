...
<div id="tour">
    ...
    <div class="tour-slide txt" id="tourSlide2">
        <p><?=$this->lang->line('tour_2_text_1')?><br /> <img src="<?=$this->config->item('base_url')?>design/tour/icon_wood.gif" /> <?=$this->lang->line('tour_2_text_2')?>, <img src="<?=$this->config->item('base_url')?>design/tour/icon_wine.gif" /> <?=$this->lang->line('tour_2_text_3')?>, <img src="<?=$this->config->item('base_url')?>design/tour/icon_marble.gif" /> <?=$this->lang->line('tour_2_text_4')?>, <img src="<?=$this->config->item('base_url')?>design/tour/icon_glass.gif" /> <?=$this->lang->line('tour_2_text_5')?> <img src="<?=$this->config->item('base_url')?>design/tour/icon_sulfur.gif" /> <?=$this->lang->line('tour_2_text_6')?>.</p><p><?=$this->lang->line('tour_2_text_7')?></p><br/>
