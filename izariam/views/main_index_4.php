...
<head>
    ...
    <!--
	<script type="text/javascript" src="<?=$this->config->item('script_url')?>js/flowplayer-3.2.13.min.js"></script>
	-->
    ...
    <script type="text/javascript">     
        ...
        // include desktop js                           
            ...
            jsInclude(window.jsUrl, [ [ '', 'flowplayer-3.2.13.min.js' ], [ '', 'jquery.fancybox-1.3.1.pack.js' ],  /*[ '', 'desktopFunctions.js' ],*/ [ '', 'jquery.mousewheel-3.0.2.pack.js' ], [ '', 'BigInt.js' ], [ '', 'Barrett.js' ] ] );
            $(document).ready(function() {
                ...
                flowplayer("player", { src: "<?=$this->config->item('style_url')?>vid/flowplayer-3.2.18.swf", wmode: 'transparent'},
                   {  
                    clip: {
                        autoPlay: false
                        ...
                        <form id="oiLoginForm" name="oiLoginForm" action="" method="post">
                            ...
                            <div class="input-wrap">
                                ...
                                <select name="universe" id="oiServer" class="validate[required]">
									...
									<?}?>
									<?if ($this->config->item('chi')) {?>
                                    <option  class="" value="chi" fbUrl="" cookieName="">Chi</option>
                                    <?}?>
									<?if ($this->config->item('delta')) {?>
                                    <option  class="" value="delta" fbUrl="" cookieName="">Delta</option>
                                    <?}?>
									<?if ($this->config->item('epsilon')) {?>
                                    <option  class="" value="epsilon" fbUrl="" cookieName="">Epsilon</option>
                                    <?}?>
									<?if ($this->config->item('eta')) {?>
                                    <option  class="" value="eta" fbUrl="" cookieName="">Eta</option>
                                    <?}?>
									<?if ($this->config->item('gamma')) {?>
                                    <option  class="" value="gamma" fbUrl="" cookieName="">Gamma</option>
                                    <?}?>
									<?if ($this->config->item('kappa')) {?>
                                    <option  class="" value="kappa" fbUrl="" cookieName="">Kappa</option>
                                    <?}?>
									<?if ($this->config->item('lambda')) {?>
                                    <option  class="" value="lambda" fbUrl="" cookieName="">Lambda</option>
                                    <?}?>
									<?if ($this->config->item('lota')) {?>
                                    <option  class="" value="lota" fbUrl="" cookieName="">Lota</option>
                                    <?}?>
									<?if ($this->config->item('my')) {?>
                                    <option  class="" value="my" fbUrl="" cookieName="">My</option>
                                    <?}?>
									<?if ($this->config->item('ny')) {?>
                                    <option  class="" value="ny" fbUrl="" cookieName="">Ny</option>
                                    <?}?>
									<?if ($this->config->item('omikron')) {?>
                                    <option  class="" value="omikron" fbUrl="" cookieName="">Omikron</option>
                                    <?}?>
									<?if ($this->config->item('phi')) {?>
                                    <option  class="" value="phi" fbUrl="" cookieName="">Phi</option>
                                    <?}?>
									<?if ($this->config->item('pi')) {?>
                                    <option  class="" value="pi" fbUrl="" cookieName="">Pi</option>
                                    <?}?>
									<?if ($this->config->item('psi')) {?>
                                    <option  class="" value="psi" fbUrl="" cookieName="">Psi</option>
                                    <?}?>
									<?if ($this->config->item('rho')) {?>
                                    <option  class="" value="rho" fbUrl="" cookieName="">Rho</option>
                                    <?}?>
									<?if ($this->config->item('sigma')) {?>
                                    <option  class="" value="sigma" fbUrl="" cookieName="">Sigma</option>
                                    <?}?>
									<?if ($this->config->item('tau')) {?>
                                    <option  class="" value="tau" fbUrl="" cookieName="">Tau</option>
                                    <?}?>
									<?if ($this->config->item('theta')) {?>
                                    <option  class="" value="theta" fbUrl="" cookieName="">Theta</option>
                                    <?}?>
									<?if ($this->config->item('xi')) {?>
                                    <option  class="" value="xi" fbUrl="" cookieName="">Xi</option>
                                    <?}?>
									<?if ($this->config->item('ypsilon')) {?>
                                    <option  class="" value="ypsilon" fbUrl="" cookieName="">Ypsilon</option>
                                    <?}?>
									<?if ($this->config->item('zeta')) {?>
                                    <option  class="" value="zeta" fbUrl="" cookieName="">Zeta</option>
                                    <?}?>
                              </select>
                            </div>
