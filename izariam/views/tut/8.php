...
<div id="tutorialMessage">
    ...
    <div class="content">
    <p>Important not easier to construct new buildings, but also to develop them. For this purpose enter into one of buildings and press the button <b> to lift </b..> <br>
<br>
Also it is not necessary to forget: you can improve only one building lumpsum. It is important still, that you take part in improvement of a sawmill, resource strip mine and an altar. These island designs are used by all players in an equal measure and, consequently, should improve by all players. If to not admit to it participation, you can offend other players. </p>
