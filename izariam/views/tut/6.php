...
<div id="tutorialMessage">
    ...
    <p>Hello,<br />
<br>
My name is the Ajax. I can tell to you about all movement of fleet which I know, as well as about the going and completed battles. In it there is nothing terrible for you as gods continuously observe of you with<a href="<?=$this->config->item('base_url')?>game/informations/11/"> Heavens</a>, protecting your empire from encroachments. <br/>
<br>
But to be ready to the future events, I recommend you to familiarize with base features of conducting operations.The first, that it is necessary for you to make, it <b> to employ some fighters </b>. That it to make, it is necessary to come into a barracks and to begin training the soldier. Then press a yellow tag in your city to construct <b> a city wall</b>.</p>
