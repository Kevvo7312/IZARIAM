...
<div id="tutorialMessage">
    ...
    <div class="content">
    <p>Hello,<br />
My name is ?????. I shall inform you on all events occuring to other civilizations. <br><br>
At the given stage, I would recommend to you to construct <b> trading port</b>. That it to make, click on one of dark blue tags. Then you can come into trading port and get there the trading ship. The trading ships are necessary for transportation of the goods other cities, as well as for robberies of resources.<br />
<br>
To transport the goods and the soldier, use the button ' the World '. Choose island and then choose city of purpose. If you have problems on navigation on the world, I recommend you to visit ????????, especially page about<a href="<?=$this->config->item('base_url')?>game/informations/12/"> Navigation </a> where you will find answers to your questions. </p>
