...
<div id="tutorialMessage">
    ...
    <div class="content">
    <p>
        <?=$this->lang->line('training')?>,<br /><br />I ??????, the chief of a sawmill. Our diligent workers work here on creation of building materials for structures and the ships. Building materials also are necessary for training ours the soldier.Send on a sawmill through the button ` Island ` and appoint how many your residents will work there. For return to city push a button ` City `.
    </p>
