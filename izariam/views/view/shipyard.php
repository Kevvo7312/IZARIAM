...
?>
                    <li class="unit <?=$class?>">
                        <div class="unitinfo">
                            ...
                            <a title="Learn more about this ship <?=$this->Data_Model->army_name_by_type($i)?>" href="<?=$this->config->item('base_url')?>game/unitDescription/<?=$i?>">
...
<?if(   ($this->Player_Model->levels[$this->Player_Model->town_id][4] < 1) or
        ...
        ($i == 22 and $this->Player_Model->levels[$this->Player_Model->town_id][4] < 7)){  // 7?>
                        <div class="forminput">Level of a building too low!</div>
<?}else{?>
                        <div class="forminput">
...
<?}}?>
                        <div class="costs">
                            ...
                            <ul class="resources">
<?if($cost['peoples'] > 0){?>
                                <li class="citizens" title="Граждане"><span class="textLabel">Citizens: </span><?=$cost['peoples']?></li>
<?}?>
<?if($cost['wood'] > 0){?>
                                <li class="wood" title="Стройматериалы"><span class="textLabel">Building Materials: </span><?=number_format($cost['wood'])?></li>
<?}?>
<?if($cost['sulfur'] > 0){?>
                                <li class="sulfur" title="Сера"><span class="textLabel">Sulfur: </span><?=number_format($cost['sulfur'])?></li>
<?}?>
<?if($cost['wine'] > 0){?>
                                <li class="wine" title="Виноград"><span class="textLabel">Wine: </span><?=number_format($cost['wine'])?></li>
<?}?>
<?if($cost['crystal'] > 0){?>
                                <li class="glass" title="Хрусталь"><span class="textLabel">Glass: </span><?=number_format($cost['crystal'])?></li>
<?}?>
<?if($cost['gold'] > 0){?>
                                <li class="upkeep" title="Содержание в час"><span class="textLabel">Содержание в час: </span><?=number_format($cost['gold'])?></li>
<?}?>
<?if($cost['time'] > 0){?>
                                <li class="time" title="Время постройки"><span class="textLabel">Minutes: </span><?=format_time($cost['time'])?></li>
<?}?>
                            </ul>
                        </div>
                    </li>
