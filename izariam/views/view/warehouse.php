...
<?include_once('building_description.php')?>
    <div class="contentBox01h">
        <h3 class="header"><span class="textLabel">Town goods overview</span></h3>
        <div class="content">
...
<p style="padding-top:10px;padding-left:18px;padding-right:10px;padding-bottom:0px;">
            Warehouses in this city:&nbsp<?=$this->Player_Model->warehouses[$this->Player_Model->town_id]?>&nbsp levels:&nbsp <?$i = 0;foreach($this->Player_Model->warehouses_levels[$this->Player_Model->town_id] as $level){?><?=$level?><?if(($i+1) != SizeOf($this->Player_Model->warehouses_levels[$this->Player_Model->town_id])){?>, <?}$i++;}?><br>
</p>
<?}?>
            <table class="table01">
                <thead>
