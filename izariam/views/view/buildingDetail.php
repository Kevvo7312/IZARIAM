...
<div id="mainview">
    ...
    <div class="contentBox01h">
        ...
        <div class="content">
            ...
            <!--<p><b>Requirements</b> <p>Researchers: No</p></p>-->
...
<?if($id==6){?>
                <tr>
                    ...
                    <td title="<?=$this->lang->line('wine')?>" class="warehouseMaterial"><img src="<?=$this->config->item('style_url')?>skin/resources/icon_wine.gif" alt="Grapes"></td>
                </tr>
<?}?>
