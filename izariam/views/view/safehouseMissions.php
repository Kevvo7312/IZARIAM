...
<div id="mainview">
    <div class="buildingDescription">
        <h1>Missions</h1>
        <p>Assign missions to spy</p>
    </div>
    <div class="contentBox01h">
        <h3 class="header"><span class="textLabel">Choose a mission for the spy in <?=$this->Data_Model->temp_towns_db[$spy->to]->name?></span></h3>
        <div class="content" style="position:relative">
            <div class="percentage"><?=$spy->risk?>%</div>
            <h4><span class="textLabel">Risk of exposure:</span></h4>
            <div class="missionText">
                <div title="Risk of exposure: <?=$spy->risk?>%" class="statusBar">
...
?>
                <li class="gold">
                    <div title="Type" class="missionType">Espoinage of treasury</div>
                    <div title="Description" class="missionDesc">It will be difficult to infiltrate the city treasury . However, if sucessful it will be possible to report back on their quantity of gold.                    </div>
                    <div title="Costs" class="missionCosts"><strong>Cost:</strong>
                    	<span class="textLabel">Gold: </span><span class="gold">45</span>
                    </div>
                    <div title="Risk" class="missionRisk"><strong>Risk:</strong> <?=$risk?>%</div>
                    <div title="3" class="missionStart">
                        <div class="centerButton">
                            <a class="button" href="<?=$this->config->item('base_url')?>actions/espionage/<?=$spy->from?>/<?=$spy->id?>/3/">Start mission</a>
                        </div>
                    </div>
                </li>
<?
