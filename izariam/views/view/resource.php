...
<div id="mainview">
    <div class="buildingDescription">
        <h1>Saw Mill</h1>
        <p>Wood from the nearby forest is sawed into boards at the sawmill. It is then used as material for constructing buildings and much more.The saw mill is extended by all inhabitants of the island.The larger it is, the more workers you can employ there.</p>      
    </div>
	<?php
