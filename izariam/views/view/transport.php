<div id="mainview">		
	...
	?>
        <div id="setPremiumTransports" class="contentBox">
            ...
            <div class="content">
                <p>Seamen are ready to go to the ends of the earth for a little abrosia, You can employ transports for 5 units of ambrosia to increase carrying capacity of the fleet.</p>
                <label for="textfield_premium">Hired Transport:</label>
                <p class="costs">Cost:: <span id="ambrosiaCosts">5</span><img src="<?=$this->config->item('style_url')?>skin/premium/ambrosia_icon.gif" width="24" height="20" alt="Амброзия" title="Амброзия"/> (У Вас есть <?=$this->Player_Model->user->ambrosy?>)</p>
                <p class="PremiumTransportsButton">
                    <div class="centerButton">
                        <a class="button" href="<?=$this->config->item('base_url')?>game/premiumPayment/">Confirm</a>
                    </div>
                </p>
            </div>
