...
/*
 * Project: iZariam
 * File: install/templates/index.php
 * Edited: 07/03/2012
 * By: ZZJHONS
 * Info: zzjhons@gmail.com
 */
?>
<center><h1>Disclamer</h1></center>
<ul>
	...
	<li><strong>You haven't rights to:
		<ul>
	 		<li>Edit copyright notices.</li>
	 		<li>Claim this script as your own.</li>
	 		<li>Sell this script/game.</li>
		</ul>
	</strong></li>
	<li>Last but not the least, Enjoy.</li>
</ul>
<h2>iZariam Team</h2>
